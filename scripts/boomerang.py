...
fly_over = load_sound("data/sounds/boomerang.ogg")
fly_over.set_volume(0.34)
...
class Boomerang(Mob):
    ...
    def custom_update_actions(self, platforms, new_sprites_group, player):
        ...
        if p_dis < 25 and not player.winning and not player.inmunity_damage and not player.loosing:
